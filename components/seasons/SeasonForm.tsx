...
const formSchema = z.object({
  ...
  // Not `.default(false)`: a default makes the field optional on the way in and
  // required on the way out, so `z.infer` no longer describes what the form
  // holds and every `control` in here stops matching. `defaultValues` below
  // supplies the false, which is the only place it was ever coming from.
  isCurrent: z.boolean(),
